...
function Bruh() {
  ...
  const handleCommand = (command) => {
    ...
    switch (command.trim()) {
      ...
      case "about":
        newOutput = [];
        newOutput.push(
          <img src="IMG_4347.JPG" alt="Anthony Park" style={{ width: '300px', height: '200px' }} />
        );
        newOutput.push(
          "Hi! I'm Anthony Park. I'm a recent graduate of Northeastern University (Class of 2026). " +
          "I majored in Computer Science, with a concentration in software. I am currently seeking a full-time position. If " +
          "you're looking for more information on my skills, projects, and work experience, type \"resume\" or \"github\". " +
          "For contact information, type \"contact\". For other commands, type \"help\""
        );
        break;
      case "help":
  ...
  return (
    <div id="screen" onClick={() => inputRef.current.focus()}>
      <img src="scanlines.png" id="scan" className="noselect" alt="" />
      <img src="bezel.png" id="bezel" className="noselect" alt="" />
      ...
      <div id="content">
        ...
        <div id="terminal">
          <div id="startText" className="animated-text">
            {startScreen && (
              <div>Welcome to my Website! My name is Anthony Park. Type "help" for list of commands.</div>
            )}
          </div>
